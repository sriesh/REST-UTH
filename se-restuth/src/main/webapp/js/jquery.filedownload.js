...
$.extend({
    ...
    fileDownload: function (fileUrl, options) {
        ...
        var defaultFailCallback = function (responseHtml, url) {
            ...
            alert("An error has occurred during exporting the content.");
        };
        ...
        var settings = $.extend({
            ...
            //Args: url - the original url attempted
        ...
        onSuccess: function (url) {
            ...
            var childElement = document.getElementById('overlay');
        ...
        function checkFileDownloadComplete() {
            ...
            if (document.cookie.indexOf(settings.cookieName + "=" + settings.cookieValue) != -1) {
                ...
                document.cookie = settings.cookieName + "=; expires=" + date.toUTCString() + "; fileDownloadPath=" + settings.cookiePath;
                cleanUp(false);
                return;
            }
